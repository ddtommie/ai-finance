...
<table>
    ...
    <tr>
        ...
        <td><ul>
            ...
            <li>Got it running locally in vscode</li>
            <li>Connected the domain and deployed the site to Vercel</li>
            </ul>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><ul>
            ...
            <li>It generates a markdown table which gets streamed to the interface</li>
        </ul>
    </td>
    </tr>
    <tr>
